      ...
      <DashboardWrapper>
        <DashboardLayoutBasic>
          <Box sx={{ width: "100%" }}>
            ...
            >
              <MenuItem value={TRANSACTION_TYPE.BETWEEN_ACCOUNTS}>Entre cuentas</MenuItem>
              <MenuItem value={TRANSACTION_TYPE.TO_THIRD_PARTIES_IN_WALLET}>Terceros en el Wallet</MenuItem>
              <MenuItem value={TRANSACTION_TYPE.INTER_WALLET}>Inter Wallet</MenuItem>
            </TextField>
